...
import com.example.android.carrental.AdminUserMessages.AdminResponsesActivity;
import com.example.android.carrental.UserAuthentication.LoginActivity;
...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidx.cardview.widget.CardView displayRentedCar = (androidx.cardview.widget.CardView)findViewById(R.id.displayRentedCarBtn);
        ...
        displayRentedCar.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdminActivity.this, DisplayRentedCarsActivity.class));
            }
        });
    }
